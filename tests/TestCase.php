...
use Code7day\LighthousePassportLogin\Providers\LighthousePassportLoginServiceProvider;
...
class TestCase extends Orchestra
{
    ...
    protected function getPackageProviders($app)
    {
        return [
            ...
            LighthousePassportLoginServiceProvider::class,
        ];
    }
    ...
    public function createClient()
    {
        ...
        config()->set('lighthouse-passport.client_id', $client->id);
        config()->set('lighthouse-passport.client_secret', $client->secret);
    }
