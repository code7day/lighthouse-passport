...
class BaseAuthResolver
{
    ...
    public function buildCredentials(array $args = [], $grantType = 'password')
    {
        ...
        $credentials['client_id'] = $args->get('client_id', config('lighthouse-passport.client_id'));
        $credentials['client_secret'] = $args->get('client_secret', config('lighthouse-passport.client_secret'));
